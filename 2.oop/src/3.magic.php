...
//    $argsAsString = array_map(function($arg) {
//      return is_array($arg) ? json_encode($arg) : (string)$arg;
//    }, $args);
//
//    echo "Args: " . implode(', ', $argsAsString) . "\n";
//  }
//}
//
//$router = new Router();
...
//
//class Processor {
//  public function process(array $data, IStrategy $strategy) {
...
class QueryBuilder {
  ...
  public function __call(string $name, array $args): self {
    ...
    if ($name === 'orderBy') {
      $this->orderBy[] = $args[0] ?? null;
      return $this;
    }

    if ($name === 'limit') {
      $this->limit = $args[0] ?? null;
      return $this;
    }
  ...
  public function getSql(): string {
    ...
    return "SELECT $select FROM $from $whereString $orderString $limitString;";
  }
